...
<main class="container mx-auto px-4 pt-6 pb-10 max-w-lg">
  <div class="mb-8">
    ...
    <p class="text-neutral-500 text-xs mt-1 font-medium italic">
      Vuelve a ver los platillos que más te gustaron
    </p>
  </div>
  ...
  <div class="space-y-4 pb-12">
    ...
    {#if savedDishes.length === 0}
      <div class="text-center py-20">
        ...
        <p class="text-stone-400 font-medium">Aún no tienes platillos guardados</p>
        <a href="/discover" class="btn btn-link text-orange-500 mt-2">Explorar platillos</a>
      </div>
    {/if}
  </div>
</main>
